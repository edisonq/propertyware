...
/**
 * This class stands for FinancialTransaction StructType
 * @subpackage Structs
 */
abstract class FinancialTransaction extends PWObject
{
    /**
     * The account
    ...
    public $cleared;
    /**
     * Constructor method for FinancialTransaction
     * @uses FinancialTransaction::setAccount()
     * @uses FinancialTransaction::setAmount()
     * @uses FinancialTransaction::setCleared()
     ...
     * Set account value
     * @param \StructType\Account $account
     * @return \StructType\FinancialTransaction
     */
