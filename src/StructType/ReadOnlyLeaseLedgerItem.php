...
/**
 * This class stands for ReadOnlyLeaseLedgerItem StructType
 * @subpackage Structs
 */
abstract class ReadOnlyLeaseLedgerItem extends ReadOnlyLedgerItem
{
    /**
     * The comments
    ...
    /**
     * Constructor method for ReadOnlyLeaseLedgerItem
     * @uses ReadOnlyLeaseLedgerItem::setComments()
     * @uses ReadOnlyLeaseLedgerItem::setDate()
     * @uses ReadOnlyLeaseLedgerItem::setReferenceNumber()
     ...
     * Set comments value
     * @param string $comments
     * @return \StructType\ReadOnlyLeaseLedgerItem
     */
